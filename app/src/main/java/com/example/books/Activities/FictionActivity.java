...
public class FictionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar = findViewById(R.id.fictionToolbar);
        setSupportActionBar(toolbar);
        Objects.requireNonNull(getSupportActionBar()).setDisplayShowHomeEnabled(true);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Fiction");

        progressBar = findViewById(R.id.fictionProgressBar);
        fictionBookRef = FirebaseDatabase.getInstance().getReference().child("fiction");
        recyclerView = findViewById(R.id.fictionRecyclerview);
    ...
    private void displayComicBooks() {
        ...
        Query displayBooksInDescending = fictionBookRef;
            ...
            protected void onBindViewHolder(@NonNull ComicActivity.BookViewHolder holder, int position, @NonNull BookModel model) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent ClickIntent = new Intent(FictionActivity.this, ClickBookCoverActivity.class);
