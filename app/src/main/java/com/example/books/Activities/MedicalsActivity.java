...
public class MedicalsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar = findViewById(R.id.medicalsToolbar);
        ...
        progressBar = findViewById(R.id.medicalsProgressBar);
        medicalBookRef = FirebaseDatabase.getInstance().getReference().child("medicals"); findViewById(R.id.medicalsRecyclerview);
    ...
    private void displayComicBooks() {
        ...
        Query displayBooksInDescending = medicalBookRef;
            ...
            protected void onBindViewHolder(@NonNull ComicActivity.BookViewHolder holder, int position, @NonNull BookModel model) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent ClickIntent = new Intent(MedicalsActivity.this, ClickBookCoverActivity.class);
