...
public class ScienceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar = findViewById(R.id.scienceToolbar);
        setSupportActionBar(toolbar);
        Objects.requireNonNull(getSupportActionBar()).setDisplayShowHomeEnabled(true);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Science");

        progressBar = findViewById(R.id.scienceProgressBar);
    ...
    private void displayComicBooks() {
        ...
        Query displayBooksInDescending = scienceBookRef;
            ...
            protected void onBindViewHolder(@NonNull ComicActivity.BookViewHolder holder, int position, @NonNull BookModel model) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent ClickIntent = new Intent(ScienceActivity.this, ClickBookCoverActivity.class);
