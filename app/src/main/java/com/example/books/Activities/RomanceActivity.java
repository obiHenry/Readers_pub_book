...
public class RomanceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar = findViewById(R.id.romanceToolbar);
        setSupportActionBar(toolbar);
        Objects.requireNonNull(getSupportActionBar()).setDisplayShowHomeEnabled(true);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Romance");

        progressBar = findViewById(R.id.romanceProgressBar);
        romanceBookRef = FirebaseDatabase.getInstance().getReference().child("romance");
        recyclerView = findViewById(R.id.romanceRecyclerview);
    ...
    private void displayComicBooks() {
        ...
        Query displayBooksInDescending = romanceBookRef;
            ...
            protected void onBindViewHolder(@NonNull ComicActivity.BookViewHolder holder, int position, @NonNull BookModel model) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent ClickIntent = new Intent(RomanceActivity.this, ClickBookCoverActivity.class);
