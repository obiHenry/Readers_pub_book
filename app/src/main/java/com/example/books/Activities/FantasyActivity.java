...
public class FantasyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar = findViewById(R.id.fantasyToolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("fantasy");

        view = findViewById(R.id.fantasyErrorMessage);
        progressBar = findViewById(R.id.fantasyProgressBar);
        fantasyBookRef = FirebaseDatabase.getInstance().getReference().child("fantasy");
        recyclerView = findViewById(R.id.fantasyRecyclerview);
    ...
    private void displayComicBooks() {
        ...
        Query displayBooksInDescending = fantasyBookRef;
            ...
            protected void onBindViewHolder(@NonNull BookViewHolder holder, int position, @NonNull BookModel model) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent ClickIntent = new Intent(FantasyActivity.this, ClickBookCoverActivity.class);
